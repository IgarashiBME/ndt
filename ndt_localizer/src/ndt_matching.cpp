...
#include <ndt_msgs/ConfigNDT.h>

#include <ndt_msgs/NDTStat.h>
...
static ndt_msgs::NDTStat ndt_stat_msg;
...
static void param_callback(const ndt_msgs::ConfigNDT::ConstPtr& input)
{
...
int main(int argc, char** argv)
{
  ...
  ndt_stat_pub = nh.advertise<ndt_msgs::NDTStat>("/ndt_stat", 10);
